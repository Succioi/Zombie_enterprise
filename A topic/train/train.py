...
X = dataset[0:75079, 2:21].astype(float)
Y = dataset[0:75079, 21]
encoder_Y = [0]*39798 + [1]*35280
...
model.fit(X_train, Y_train, batch_size=64, epochs=20, verbose=1, validation_data=(X_test, Y_test), callbacks=[his])
model.summary()
